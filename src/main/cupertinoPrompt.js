    ...
    class WackCupertinoRestPrompt extends St.BoxLayout {
        _init(user, extension) {
            ...
            this._hintLabel = new St.Label({
                style_class: 'wack-cupertino-hint-label',
                text: '',
                y_align: Clutter.ActorAlign.CENTER,
            });
            this._hintLabel.clutter_text.set_line_wrap(true);
            this._hintLabel.clutter_text.set_line_wrap_mode(Pango.WrapMode.WORD_CHAR);
            this._hintLabel.clutter_text.set_ellipsize(Pango.EllipsizeMode.NONE);
