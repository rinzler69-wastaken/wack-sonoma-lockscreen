...
## [PRO] GDM Login Screen Customization (Optional DLC)
...
Unless you installed this extension from ```git clone```, you can just run the scripts in ```scripts``` directory directly.
